...
app.get('/search', (req, res) => {
    const search = req.query.search // the part that comes after query has to equal what I put as "name" in the EJS file
    let searchApi = "https://api.themoviedb.org/3/search/movie?api_key=9dbfde2a8b6e92417ef7a6cc5cb516fd&query=" + search
